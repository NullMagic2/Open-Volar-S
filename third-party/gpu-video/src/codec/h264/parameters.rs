...
impl<'a> H264DecodeProfileInfo<'a> {
    pub(crate) fn from_sps_decode(
        ...
        let picture_layout = match sps.frame_mbs_flags {
            h264_reader::nal::sps::FrameMbsFlags::Frames => vk::VideoDecodeH264PictureLayoutFlagsKHR::PROGRESSIVE,
            _ => vk::VideoDecodeH264PictureLayoutFlagsKHR::INTERLACED_INTERLEAVED_LINES,
        };
