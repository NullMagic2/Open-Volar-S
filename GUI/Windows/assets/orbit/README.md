...
The material textures and images remain reusable, independent of the button labels and dynamic receiver state. `GUI/Windows/src/orbit.rs` owns the native layout and lighting; `GUI/Windows/src/dial.rs` owns pointer interpolation and sampling.
